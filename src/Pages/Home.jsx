...
import TrendingHotel from '../Components/Trending Hotels/TrendingHotel';
import PopularHotels from '../Components/Popular Hotels/PopularHotels';
import Testimonials from '../Components/SideBars/Testimonials';
...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className='flex w-screen h-screen items-center justify-center' id={styles.HomeBg}>
        <div className='flex flex-col max-w-7xl justify-center items-center'>
          ...
          <span className='py-1.5 px-5 cursor-pointer rounded-sm text-cyan-200 bg-red-500 mx-3 ease-linear duration-200 hover:-translate-y-1'><button className='py-1'>Discover Now</button></span>
        </div>
      ...
      <section className='flex w-screen h-auto mt-32 items-start justify-center'>
        <div className='flex flex-col h-auto gap-3 p-2 w-full max-w-7xl justify-between items-center xl:flex-row xl:items-start sm:p-0'>
          <PopularHotels />
          <Testimonials />
        </div>
      </section>
